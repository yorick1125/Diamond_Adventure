...
while run:
        ...
        try:
            ...
            with open(f'level{level}_data.csv', 'w', newline='') as csvfile:
                ...
                for row in world_data:
                    writer.writerow(row)
                print("Level " + str(level) + " saved successfully.")
                # pickle_out = open(f'level{level}_data', 'wb')
                # pickle.dump(world_data, pickle_out)
                # pickle_out.close()
        except:
            print("Level " + str(level) + " could not be saved")
    ...
    if load_button.draw(screen):
        try:
            ...
            print("Level " + str(level) + " loaded successfully.")
            ...
            print("Level " + str(level) + " could not be loaded")
